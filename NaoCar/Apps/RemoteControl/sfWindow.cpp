  ...
  _pipeline(NULL), _resize(true), _currentCameraMode(0)
{
  ...
  tmp.loadFromFile("Apps/RemoteControl/resources/move-left-active.png");
  _textures["MoveLeftOn"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/move-left-inactive.png");
  _textures["MoveLeftOff"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/move-right-active.png");
  _textures["MoveRightOn"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/move-right-inactive.png");
  _textures["MoveRightOff"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/move-up-active.png");
  _textures["MoveUpOn"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/move-up-inactive.png");
  _textures["MoveUpOff"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/move-down-active.png");
  _textures["MoveDownOn"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/move-down-inactive.png");
  _textures["MoveDownOff"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/shift-up.png");
  _textures["CurrentSpeedUp"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/shift-down.png");
  _textures["CurrentSpeedDown"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/say-field.png");
  _textures["Say"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/button-camera-front.png");
  _textures["SelectCameraTop"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/button-camera-bottom.png");
  _textures["SelectCameraBottom"] = tmp;
  tmp.loadFromFile("Apps/RemoteControl/resources/logo.png");
  _textures["Logo"] = tmp;
...
void	Window::exec()
{
  ...
  while (_window.isOpen())
	...
	_streamSprite.setScale(sf::Vector2f((float)_window.getSize().x / w,
      ...
      _window.draw(tmpSprite);
      tmpSprite.setTexture(_textures[_module.speed() == DriveProxy::Up ?
				     "CurrentSpeedUp" : 
      ...
      _window.draw(tmpSprite);
      tmpSprite.setTexture(_textures[_module.speed() == DriveProxy::Down
				     && _module.isGasPedalPushed() ?
